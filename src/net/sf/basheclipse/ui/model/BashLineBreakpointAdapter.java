...
import net.sf.basheclipse.core.model.BashLineBreakpoint;
...
public class BashLineBreakpointAdapter implements  IToggleBreakpointsTargetExtension{//IToggleBreakpointsTarget
	...
	public void toggleLineBreakpoints(IWorkbenchPart part, ISelection selection) throws CoreException {
		...
		if (textEditor != null) {
			...
			IBreakpoint[] breakpoints = DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(IBashConstants.ID_BASH_DEBUG_MODEL);
